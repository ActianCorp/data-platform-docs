---
title: "Examine the Database Schema"
product: "Actian Data Platform"
guide: "Warehouse User Guide"
source_file: "Examine_the_Database_Schema.htm"
canonical_id: "actian-data-platform-examine-the-database-schema"
---

## Examine the Database Schema

When a database schema is displayed in the schema pane on the left side of the editor (see [Query Editor Diagram](../User/Query_Editor_Diagram.md)), you may examine the tables and columns by clicking them. Columns and their data types are displayed.

To choose a database connection

Click the database connection dropdown at the top of the schema pane:

![](images/ChooseConnectionDropdown.png)

![](images/ChooseConnectionDropdown_GCP.png)
...
- Monitoring (imadb) – see [Working with Monitoring (imadb) Tables](../User/Working_with_Monitoring_(imadb)_Tables.md)

AWS AV-1 and Azure:To display or hide the schema

Click the Toggle Schema icon:

![](images/ToggleSchemaIcon.png)
...
For more information, see [Export Query Results to a File](../User/Export_Query_Results_to_a_File.md).
