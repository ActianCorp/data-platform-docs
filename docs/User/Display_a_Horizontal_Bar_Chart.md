---
title: "Display a Horizontal Bar Chart"
product: "Actian Data Platform"
guide: "Warehouse User Guide"
source_file: "Display_a_Horizontal_Bar_Chart.htm"
canonical_id: "actian-data-platform-display-a-horizontal-bar-chart"
---

## Display a Horizontal Bar Chart

To display a horizontal bar chart
...
3. From the Type of Visualization dropdown menu, select Bar - Horizontal.
...
| Bar Value Facet | The query result column to use to break the chart into multiple small charts. A small chart will be created for each value in the column, along the axis that holds the bar value. |
