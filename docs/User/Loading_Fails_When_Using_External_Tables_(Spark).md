...
Re-enter your Azure Storage or AWS S3 credentials, depending on which cloud platform you are using, and then retry the SQL statement. Alternatively, you can stop and restart the warehouse. For more information, see [Stop a Warehouse](../User/Stop_a_Warehouse.md) and [Restart a Warehouse](../User/Restart_a_Warehouse.md).
