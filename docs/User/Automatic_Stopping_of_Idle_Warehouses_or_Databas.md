...
You can set the idle stop time at warehouse/database creation from a minimum of 0 hours, 15 minutes to a maximum of 4 hours, 45 minutes. For more information, see [Create a New Warehouse](../User/Create_a_New_Warehouse.md) or [Create a New Database Instance](../User/Create_a_New_Database_Instance.md).
