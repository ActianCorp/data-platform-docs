...
source_file: "Log_In.htm"
canonical_id: "actian-data-platform-log-in"
---
...
| --- | --- |
| Actian Community | • AWS, Azure data, Google Cloud warehouses<br>• Integrations |
| Actian Data Platform User | • Google Cloud data sources<br>• Integrations |
...
- Signing up for the Actian Data Platform on the GCP marketplace
- Establishing a proof of concept or Enterprise setup (manually by Actian Corporation)

- Being provided access by an existing Account Administrator, who provides platform user credentials (see [User Roles](../User/User_Roles.md))

The capabilities provided by your corporate account determines how you should log in and what Platform features you will be able to access.

To log in to Platform
