...
To keep your data costs down, compute and storage are separated in the Actian Data Platform, so you pay only for what you use. For more information, see [Warehouse or Database Cost and Actian Units](../User/Concepts_to_Understand.md).
