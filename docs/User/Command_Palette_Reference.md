...
source_file: "Command_Palette_Reference.htm"
canonical_id: "actian-data-platform-command-palette-reference"
---
...
| Select All Occurances of Find Match | Ctrl + Shift + L |
| Show Accessibility Help | Alt + F1 |
| Show Editor Context Menu | Shift + F10 |
| Show Hover | Ctrl + K Ctrl + I |
| Shrink Selection | Shift + Alt + LeftArrow |
| Toggle Tab Key Move Focus | Ctrl + M |
| Toggle Block Comment | Shift + Alt + A |
| Toggle Fold | Ctrl + K Ctrl + L |
| Toggle Line Comment | Ctrl + / |
| Trigger Sugget | Ctrl + Space |
| Trim Trailing White Space | Ctrl + K Ctrl + X |
| Unfold | Ctrl + Shift + ] |
| Unfold All | Ctrl + Shift + J |
