...
source_file: "Display_a_Pie_Chart.htm"
canonical_id: "actian-data-platform-display-a-pie-chart"
---
...
3. From the Type of Visualization dropdown menu, select Pie.

    Fields for the chart type are displayed.

4. Set values for each field:

| Field | Description |
| --- | --- |
| Pie Label | The column used for the label field |
| Pie Value | The column used for the values |

5. Click Create Chart.

    The graph is displayed.

6. Click the Switch to Doughnut Chart link to display the chart as a doughnut.
