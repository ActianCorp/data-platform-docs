...
source_file: "DeleteWarehouse.htm"
canonical_id: "actian-data-platform-deletewarehouse"
---
...
!!! note "Note"
    ...
    For AWS AV-1 and Azure, it takes about 10 minutes to delete a warehouse. For Google Cloud and AWS AV-2, it takes a few seconds.
