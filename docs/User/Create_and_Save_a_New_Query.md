...
source_file: "Create_and_Save_a_New_Query.htm"
canonical_id: "actian-data-platform-create-and-save-a-new-query"
---
...
2. Enter your query text in the query pane.
    ...
    Auto-complete options appear as you type. For more information about editing capabilities, see [Edit Queries](../User/Edit_Queries.md).

3. Enter a unique name for the query in the Query Name field on the toolbar.
4. Click the Save icon.

    The saved query is now available in the Queries dialog (see [Open a Saved Query](../User/Open_a_Saved_Query.md)).

Google Cloud and AWS AV-2:To create a new query

1. On the Query Editor toolbar, click the Add New Query icon: ![](images/QueryEditor_NewQueryButton.png)
...
5. Click the Save button.
    ...
    The saved query is now available in the Saved Queries panel (see [Open a Saved Query](../User/Open_a_Saved_Query.md)).
