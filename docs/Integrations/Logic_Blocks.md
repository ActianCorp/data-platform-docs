...
| Inputs | Operand1 – A number or a string.Operand2 – A number or a string.Comparison operator – You can select from:<br>• = (Equals operator)<br>• ≠ (Not equals operator)<br>• < (Less than operator)<br>• ≤ (Less than or equal to operator)<br>• > (Greater than operator)<br>• ≥ (Greater than or equal to operator) |
...
| Inputs | Operand1 – A number or a string.Operand2 – A number or a string.Comparison operator – You can select from:<br>• And (And operator)<br>• Or (Or operator) |
