...
| Informix Database Server Locale | Specifies the locale of the server on which the HCL Informix 14.10 database is hosted. The default setting is EN_US.819. Select one of the following:• EN_US.819• EN_US.UTF8This property is mandatory. |
