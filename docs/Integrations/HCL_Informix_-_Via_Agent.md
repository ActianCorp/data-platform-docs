---
title: "HCL Informix - Via Agent"
product: "Actian Data Platform"
guide: "Integrations Guide"
source_file: "HCL_Informix_-_Via_Agent.htm"
canonical_id: "actian-data-platform-hcl-informix-via-agent"
---

## HCL Informix - Via Agent
...
This topic describes how to connect via agent using the HCL Informix connector. This option is useful for reading data from a HCL Informix 14.10 database that is located behind a firewall (hosted on-premise). This connector is available if Connect via Agent is enabled when creating a new connection or integration.
...
- HCL Informix ODBC driver must be installed on the same machine where Actian Integration Agent is installed.
...
| Informix Server | Specifies the name of the server on which the HCL Informix 14.10 database is hosted.This property is mandatory. |
| Informix Database Name | Specifies the name of the HCL Informix 14.10 database to connect to.This property is mandatory. |
...
| Informix Database Server Locale | Specifies the locale of the server on which the HCL Informix 14.10 database is hosted. The default setting is EN_US.819. Select one of the following:<br>• EN_US.819<br>• EN_US.UTF8This property is mandatory. |
...
| Preview the first 20 records | Click to preview the first 20 records. Use this to verify that you’re connected to the correct table.Data for the selected source table is displayed in the source data preview pane.Click ![](images/DesignWorkspace_117.png) and enter a string to search for a particular record. |
