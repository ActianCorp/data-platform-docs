...
If you’re [Creating a Data Profile](../DataQuality/Creating_a_Data_Profile.md) or [Creating a Connection](../DataQuality/Creating_a_Connection.md), see [Source Details for Actian Vector](../DataQuality/Actian_Vector.md) to [Define Source](../DataQuality/Define_Source.md).

- [Prerequisites](../DataQuality/Actian_Vector.md)
- [Source Details for Actian Vector](../DataQuality/Actian_Vector.md)

- [Additional Information](../DataQuality/Actian_Vector.md)
...
Source Details for Actian Vector

This topic provides properties and details needed to create a new connection and specify the source table using the Actian Vector connector, as well as other options that are presented when you [Define Source](../DataQuality/Define_Source.md).

When finished entering this information your connection to Actian Vector will be established. You will then be guided to the next Step in [Creating a Data Profile](../DataQuality/Creating_a_Data_Profile.md): [Define Rules and Analyze Results](../DataQuality/Define_Rules_and_Analyze_Results.md).
...
| Server Host Name | Specifies the URL or IP address of the server that hosts Actian Vector. This property is mandatory. |
...
| Test | Click to verify your connection and click Save. |
...
| Preview the first 20 records | Click to preview the first 20 records. Use this to verify that you’re connected to the correct table.Data for the selected source table is displayed in the source data preview pane.Click ![](images/Design_53.png) and enter a string to search for a particular record. |
