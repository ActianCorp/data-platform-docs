...
| Rule Parameters | Zip Code Format: Select from a list of countries. You can select from:•Canada•Germany•India•United Kingdom•United StatesFor a description of Zip Code Format options, see Remarks. |
