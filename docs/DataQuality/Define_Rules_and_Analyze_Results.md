...
| ![](images/Design_16.png) | Click this icon to sort the rules:<br>• Descending by Fail: (Default) Sort the rules in descending order based on failures.<br>• Descending by Pass: Sort the rules in descending order based on success.<br>• Rule name A-Z: Sort the rules in alphabetical order. |
