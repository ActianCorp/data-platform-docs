...
| --- | --- |
| •[Rule Sets](../DataQuality/Rule_Sets.md)•Select All option for [Inspect & Recommend Rules](../DataQuality/Inspect___Recommend_Rules.md)•Execute Profiles in background when you [Define Targets](../DataQuality/Define_Targets.md)•Adjust sample size for data loading for [Define Rules and Analyze Results](../DataQuality/Define_Rules_and_Analyze_Results.md)•Evaluate rules with new source details for [Inspect & Recommend Rules](../DataQuality/Inspect___Recommend_Rules.md) | October, 2024 |
| •[Define Source](../DataQuality/Define_Source.md)•[Source and Target Connections](../DataQuality/Source_and_Target_Connections.md)•[Define Rules and Analyze Results](../DataQuality/Define_Rules_and_Analyze_Results.md)•[Run History for all Profiles](../DataQuality/Run_History_for_all_Profiles.md)•[Managing Configurations](../DataQuality/Managing_Configurations.md)•[Run History for all Configurations](../DataQuality/Run_History_for_all_Configurations.md) | May 11, 2024 |
