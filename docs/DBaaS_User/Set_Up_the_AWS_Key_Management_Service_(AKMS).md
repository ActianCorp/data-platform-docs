...
1. Initiate adding an access key in Actian
2. Create a symmetric key in AWS

3. Complete your access key in Actian
4. Select your AWS-managed key for encryption when creating warehouse

## Add an Access Key in Actian

To add an access key in Actian
...
## Add the Actian AWS Account ID to Your AKMS Policy

To add the Actian AWS account ID to your AKMS policy
...
9. Allow Actian AWS account to use this KMS key for cryptographic operations. To do so, in the Other AWS accounts section at the bottom of the page, choose Add another AWS account and enter the AWS account identification number of Actian AWS account.

10. Add the Actian account ID from Actian Add Access Key dialog.
