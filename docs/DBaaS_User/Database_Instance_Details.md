...
| Encryption Key | Displays the method of data at rest encryption:<br>• No Encryption Key – Warehouse was created before data encryption was implemented in Actian. Encryption can only be added at warehouse creation and not after a warehouse has been created.<br>• Actiand-Managed Encryption Key – Warehouse was created before an external customer-managed KMS key alias was created, or Actiand-managed encryption key was set as the default KMS. For more information, see [Using an Actian-managed Encryption Key](../User/Using_an_Actian-managed_Encryption_Key.md).<br>• <Key alias> – Warehouse was created after an external customer-managed KMS key alias was created and assigned as the default KMS.<br>• Note: Warehouse encryption is not currently supported for Google Cloud warehouses. |
...
- Users page – [Display Users from the Warehouse Details or Database Instances Page](../DBaaS_User/Display_Users_from_the_Warehouse_Details_or_Data.md)
- Connections page – Access Warehouse or Database Connection Information

- Monitoring page – Monitor Warehouses (currently not available for Google Cloud warehouses)
- Query Editor page – [Query Editor](../DBaaS_User/Part_QueryEditor.md)
