...
1. Go to [https://esd.actian.com/product/Actian/Client_Runtime](https://esd.actian.com/product/Avalanche/Client_Runtime).
2. On the ESD download page, select your local machine’s operating system from the PLATFORM dropdown.

3. Scroll down to the Actian Actian Client Runtime section and expand it, if necessary.
