...
source_file: "Clone_a_Query.htm"
canonical_id: "actian-data-platform-clone-a-query"
---
...
![](images/CloneQueryButton.png)

    The displayed query name is prepended with “Copy of.”

![](images/QueryNameField.png)
...
![](images/QuerySaveIcon.png)
    ...
    The cloned query is now available in the Saved Queries dialog (see [Open a Saved Query](../DBaaS_User/Open_a_Saved_Query.md)).
...
![](images/CloneQueryButton_GCP.png)
...
![](images/QuerySaveIcon_GCP.png)

    The cloned query is now available in Saved Queries (see [Open a Saved Query](../DBaaS_User/Open_a_Saved_Query.md)).
