...
!!! note "Note"
    ...
    This section is for users with Account Administrator access to an Actian account. For more information, see [User Roles](../DBaaS_User/User_Roles.md).
...
!!! warning "Important"
    ...
    **IMPORTANT!**Beginning with the January 2022 release, user access to Actian has changed. If you were not previously an Account Administrator, you can still log in but will have no access to warehouses or other features. (Your user status defaults to No Role.)
    ...
    If you receive the following message, contact your Account Administrator to assign you the role of Warehouse User or Warehouse Administrator (see [User Roles](../DBaaS_User/User_Roles.md)):
