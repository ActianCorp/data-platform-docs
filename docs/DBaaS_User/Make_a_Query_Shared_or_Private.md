---
title: "Make a Query Shared or Private"
product: "Actian Data Platform"
guide: "DBaaS User Guide"
source_file: "Make_a_Query_Shared_or_Private.htm"
canonical_id: "actian-data-platform-make-a-query-shared-or-private"
---
...
![](images/QueryPrivatePublicButtons.png)
...
You can set the availability of queries the first time you save them. See [Create and Save a New Query](../DBaaS_User/Create_and_Save_a_New_Query.md).
...
3. For the query you want to modify, click the Edit Query Properties icon: ![](images/QueryEditor_EditQueryProperties_button.png)
