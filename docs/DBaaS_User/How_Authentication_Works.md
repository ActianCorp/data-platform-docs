...
The creator of the warehouse has exclusive access to Query Editor and must explicitly authorize other users (by creating the user in SQL). For more information, see [Add Native Users](../DBaaS_User/Add_Native_Users.md).
