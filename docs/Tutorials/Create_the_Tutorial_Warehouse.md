---
title: "Create the Tutorial Warehouse"
product: "Actian Data Platform"
guide: "Tutorials"
source_file: "Create_the_Tutorial_Warehouse.htm"
canonical_id: "actian-data-platform-create-the-tutorial-warehouse"
---

## Create the Tutorial Warehouse

Before you start loading or querying your data, you must create a warehouse.

To create a new Actian Data Platform warehouse

1. On the [Actian Warehouses Console](../Tutorials/Actian_Warehouses_Console.md), click the Create Warehouse button.
...
6. Enter one or more Allow Listed application IP addresses (machine addresses allowed to connect to the Actian Data Platform warehouse).
...
| Next Step![](images/getting_started_green_arrow.png) | Go to [Actian Warehouses Console](../Tutorials/Actian_Warehouses_Console.md). |
| --- | --- |
