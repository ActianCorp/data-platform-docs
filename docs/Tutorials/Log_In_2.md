...
guide: "Tutorials"
source_file: "Log_In_2.htm"
canonical_id: "actian-data-platform-log-in-2"
---
...
| Next Step![](images/getting_started_green_arrow.png) | Go to [Create the Tutorial Database](../Tutorials/Create_the_Tutorial_Database.md). |
| --- | --- |
